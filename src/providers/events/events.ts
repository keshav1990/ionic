...
export class EventsProvider {
  ...
  getEvents(d) {
    ...
    return new Promise(resolve => {
      ...
      this.http.get(this.config.url + 'getAllEvents/?customers_id=null&page_number='+d.page+'&type='+d.type+'&language_id='+data.language_id+'', data).map(res => res.json()).subscribe(data => {

        resolve(data.event_data);
